...
<header>
  <div class="hero-container" style="background-image:url(<?php bloginfo('template_directory'); ?>/dist/images/balsa-cover-image.jpg);">
  		...
  		<div class="table-box">
  				...
  				<div class="table-cell-box wow fadeIn" style="visibility:hidden;" >
  					<div class="hero-text">
  						<div class="container">
  							<div class="row">
  								<div class="col-md-6">
...
<p><a href="<?= site_url('/about-balsa/');?>" class="btn btn-warning">Learn More</a> <a href="<?= site_url('/shop/');?>" class="btn btn-primary">Shop Now &rarr;</a>
  	...
  	<div class="hero-image visible-md visible-lg wow fadeInRight" style="visibility:hidden;" >
...
<main>
	...
	<div class="container">
		...
		<div class="row wow fadeIn">
			<div class="grid-image grid-right col-sm-6 col-sm-push-6 grid-match">
				<a href="<?= site_url('/other-ways-to-order/');?>">
			...
			<div class="grid-content grid-left col-sm-6 col-sm-pull-6 grid-match">
				<div class="grid-content-wrapper text-center">
					...
					<p><a href="<?= site_url('/contact-us/');?>" class="btn btn-primary">Our Location</a> <a href="<?= site_url('/other-ways-to-order/');?>" class="btn btn-primary">Offline Orders</a></p>
				</div>
				</div>
			</div>
		</div><!-- /.row -->
	...
	<section class="page-section featured-products wow fadeIn">
		<div class="container">
			<div class="row">
				<h2 class="headline text-center">Our best sellers</h2>
